/* "Server=ACOLLINS-PC\\SQLEXPRESS;Database=DepartmentsAndEmployees;Trusted_Connection=True;"; */
    ...
    public class Repository
    {
        ...
        public SqlConnection Connection
        {
            get
            {
                ...
                string _connectionString = "Server=DESKTOP-BU9FGRB\\SQLEXPRESS;Database=DepartmentsAndEmployees;Trusted_Connection=True;";
...
//  Returns a list of all departments in the database
        ...
        public List<Department> GetAllDepartments()
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                {
                    // 1. Here we setup the command with the SQL we want to execute before we execute it.
                    cmd.CommandText = "SELECT Id, DeptName FROM Department";

                    // 2. Execute the SQL in the database and get a "reader" that will give us access to the data.
                    SqlDataReader reader = cmd.ExecuteReader();

                    // 3. A list to hold the departments we retrieve from the database.
...
// <returns>The employee that with the given id</returns>
        ...
        public Employee GetEmployeeById(int id)        
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = $"SELECT Id, FirstName, LastName, DepartmentId FROM Employee WHERE Id = @eId";
...
// TODO: Complete this method - Look at GetAllEmployeesWithDepartmentByDepartmentId(int departmentId) for inspiration
...
//  Get *** ONLY *** the employees who have the SPECIFIC DepartmentId
// Include the employee's department object.
...
//  NOTE: This method sends data to the database, 
//  it does not get anything from the database, so there is nothing to return.
// TODO: Complete this method by using an INSERT statement with SQL - Remember to use SqlParameters!
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = $@"INSERT INTO Employee
                        VALUES (@fName, @lName, @departmentId)";
                    cmd.Parameters.Add(new SqlParameter("@fName", employee.FirstName));
                    cmd.Parameters.Add(new SqlParameter("@lName", employee.LastName));
...
// TODO: Complete this method using an UPDATE statement with SQL - Remember to use SqlParameters!
...
// TODO: Complete this method using a DELETE statement with SQL - Remember to use SqlParameters!
